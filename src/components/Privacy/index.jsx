        ...
        return (
            <Fragment>
                ...
                <div className="Privacy">
                    ...
                    <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from http://www.EasyLang.app</p>
...
<h4>Facebook Authentication (Facebook, Inc.)</h4>
                    ...
                    <ul>
                        <li>
                            ...
                            <p>For more information on the privacy practices of Google, please visit the Google Privacy &amp; Terms web page: <a href="https://policies.google.com/privacy?hl=en" className="google-link"  target="_blank">https://policies.google.com/privacy?hl=en</a></p>
                        </li>
                    </ul>
